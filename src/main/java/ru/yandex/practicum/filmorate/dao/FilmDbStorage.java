...
public class FilmDbStorage implements FilmStorage {
    ...
    public List<Film> getTopFilms(Integer count, Integer genreId, Integer year) {
        ...
        String genreConditionOnly = " LEFT JOIN Genres_Relation ON films.film_id = Genres_Relation.film_id" +
                " WHERE Genres_Relation.GENRE_ID = " + genreId + " ";
        String yearAndGenreConditions =
                " LEFT JOIN Genres_Relation ON films.film_id = Genres_Relation.film_id" +
